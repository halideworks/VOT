...
| `VOT_INITIAL_CWND` | controller default | Initial congestion window in packets (10 to 44739). Set on the serve to skip most of slow start on a path the operator knows; the controller still collapses it on loss |
